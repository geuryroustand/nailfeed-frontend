...
import FeedCommentSection from "../comments/feed-comment-section"
...
export default function CommentsSection({ postId, documentId }: CommentsSectionProps) {
  return (
    <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6 p-4 sm:p-6">
