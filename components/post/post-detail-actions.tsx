...
export function PostDetailActions({
  ...
  const validImageUrl = imageUrl || "/placeholder.svg?height=400&width=400&text=Nail+Design"
  ...
  return (
    <div className="flex items-center justify-between py-2">
      ...
      <div className="flex items-center space-x-2">
        <TryOnButton designImageUrl={validImageUrl} designTitle={designTitle} variant="outline" size="sm" />
