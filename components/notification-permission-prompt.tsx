  ...
  const requestNotificationPermission = async () => {
    ...
    try {
      ...
      if (permission === "granted") {
        ...
        const result = await subscribeToPushNotifications(user.documentId, {
        ...
        if (result.success) {
          toast({
            ...
            description:
              "You'll now receive notifications for comments and interactions",
          });
          setShowPrompt(false);
        } else {
    ...
    <Card className="fixed bottom-4 right-4 w-80 z-50 shadow-lg border-pink-200">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Get notified when someone comments on your posts or interacts with
          your content
        </CardDescription>
      </CardHeader>
