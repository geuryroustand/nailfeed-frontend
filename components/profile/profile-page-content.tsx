...
export default function ProfilePageContent({ user, isOwnProfile, showGuestBanner = false }: ProfilePageContentProps) {
  // Log the user data to help with debugging
  console.log("ProfilePageContent rendering with user:", {
