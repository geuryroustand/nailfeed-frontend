      ...
      >
        <div className="absolute left-4 flex justify-center items-center">
          {isLoading === "facebook" ? (
            ...
            <svg className="h-4 w-4 flex-shrink-0" fill="#1877F2" viewBox="0 0 24 24">
          ...
          {isLoading === "instagram" ? (
            ...
            <svg className="h-4 w-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="url(#paint0_radial_instagram)"
              />
              <defs>
                <radialGradient
                  id="paint0_radial_instagram"
                  cx="0"
                  cy="0"
                  r="1"
                  gradientUnits="userSpaceOnUse"
                  gradientTransform="translate(6 17.5) rotate(-65.1363) scale(22.5942)"
                >
