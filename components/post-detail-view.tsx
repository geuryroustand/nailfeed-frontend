...
export default function PostDetailView({ post }: PostDetailViewProps) {
  ...
  const [commentOpen, setCommentOpen] = useState(true) // Open by default on detail page
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            />
            <div className="ml-3">
              <p className="text-base font-medium">{post.username}</p>
        ...
        <div className="flex items-center justify-between py-3 border-t border-b">
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500">{likeCount > 0 ? `${likeCount} likes` : ""}</span>
          </div>
        ...
        <AnimatePresence>
          {commentOpen && (
            ...
            >
              ...
              <div
                className="space-y-4 mb-4 max-h-[500px] overflow-y-auto pr-1 scrollbar-hide"
