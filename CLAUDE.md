...
This project contains server and client code. Server-only secrets are handled exclusively on the server through API routes and server actions. Client code never embeds or references secrets.
