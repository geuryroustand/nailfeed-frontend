        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Welcome to NailFeed ("we," "our," or "us"). By accessing or using
            ...
            <p className="text-gray-700">
              ...
              NailFeed regarding your use of the Services. Please read them
              carefully.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              ...
              other material ("User Content"). You retain ownership rights in
              your User Content.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              ...
              have the right to use and grant us the rights and license as
              provided in these Terms, and (ii) the posting of your User Content
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                Posting or transmitting viruses, malware, or other malicious
                code
              </li>
              <li>
              ...
              <li>
                Using the Services in a manner that could disable, overburden,
                damage, or impair the site
              </li>
              <li>
                Posting content that is defamatory, obscene, pornographic,
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              ...
              property of NailFeed and its licensors. The Services are protected
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              ...
              users of our Services to do the same. We will respond to notices
              of alleged copyright infringement that comply with applicable law.
            </p>
            <p className="text-gray-700">
              ...
              the following information: (i) a physical or electronic signature
              of the copyright owner or a person authorized to act on their
              behalf; (ii) identification of the copyrighted work claimed to
              ...
              locate the material; (iv) your contact information; (v) a
              statement by you that you have a good faith belief that use of the
              material in the manner complained of is not authorized by the
              copyright owner, its agent, or the law; and (vi) a statement that
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              ...
              NailFeed, its directors, employees, partners, agents, suppliers,
              ...
              party on the Services; (iii) any content obtained from the
              Services; and (iv) unauthorized access, use, or alteration of your
          ...
          <section>
            ...
            <p className="text-gray-700">
              NailFeed, its subsidiaries, affiliates, and licensors do not
              warrant that a) the Services will function uninterrupted, secure,
              or available at any particular time or location; b) any errors or
              defects will be corrected; c) the Services are free of viruses or
              other harmful components; or d) the results of using the Services
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              Services or delete your account.
            </p>
          </section>
