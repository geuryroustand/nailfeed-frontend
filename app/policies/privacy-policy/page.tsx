...
export const metadata: Metadata = {
  ...
  description: "Privacy policy and data protection information for Nail Art Social platform users",
}
...
export default function PrivacyPage() {
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        <Link href="/" className="inline-flex items-center text-sm font-medium text-pink-600 hover:text-pink-800">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            Welcome to Nail Art Social. We respect your privacy and are committed to protecting your personal data. This
        ...
        <section>
          ...
          <p className="text-gray-700">
            You can manage many of these rights through your account settings or by contacting us directly.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <p className="text-gray-700 mb-1">Email: privacy@nailartsocial.com</p>
