...
export default async function UserProfilePageOptimized({ params }: { params: { username: string } }) {
  try {
    ...
    return (
      <>
        <ProfilePageContentOptimized user={user} isOwnProfile={isOwnProfile} showGuestBanner={showGuestBanner} />
